...
**Note that this is a group assignment. Your group assignments (generated at random) are [found here.](https://docs.google.com/spreadsheets/d/1ss_NodHXciODstgmDfgO-LiG4izYkdQ3u02fRae2V3o/edit?usp=sharing)**

## Configuring your repository

Create a public repository in the PSTAT197 workspace and add your groupmates as collaborators.
...
3.  a script *with line annotations* that replicates all results shown in the primary vignette document end-to-end
...
-   *draft deadline* **Thursday, December 4, 3:30pm PST** (in class) -- be prepared to share a draft of your primary vignette document and explain it to a small group of other students

-   *final deadline* **Monday, December 8, 11:59pm PST** -- the repository and all contained files should be in final form ready for evaluation by course staff
