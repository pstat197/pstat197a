...
-   setup for first group assignment due next Sunday
...
1.  accept GH classroom assignment [here](https://classroom.github.com/a/iG-05GhY); this will create/add your team repo
...
Please make final commits by ***Sunday, October 20, 11:59pm PST.***

. . .

Recall there is a 24-hour grace period; any commits submitted after Monday, October 21st, 11:59pm may not receive review.
...
Try to accomplish four goals:

1.  clone the repository and create a script file
2.  pool ideas for questions or themes to explore in the data
3.  pair up, divide work, and assign tasks
4.  agree on a communication plan for finishing work
