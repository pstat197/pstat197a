...
-   groups posted \[[here](https://docs.google.com/spreadsheets/d/1ss_NodHXciODstgmDfgO-LiG4izYkdQ3u02fRae2V3o/edit?usp=sharing)\]
...
## Possible ideas for vignette topics {.smaller}
...
We fit models and generated forecasts for 26 sites chosen largely based on having overlapping observation windows.
...
register_stadiamaps(key = "b0272c4d-f3ee-478f-a1db-3d4443add3c3")
...
We also truncated the training data to stop on the same date (April 30, 2018). So we can plot point forecasts for May 1.
