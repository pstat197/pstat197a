...
1.  Pick up a name tag and write your preferred name on it (neatly).

2.  Choose a table at which to sit for the quarter and note the number.

3.  Sign in using the attendance reporting form found here:
...
3.  Fill out [capstone project intake form](https://forms.gle/ZedC6ZMHi5KhsDNH7).
