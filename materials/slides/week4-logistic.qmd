...
-   Next assignment posted on class website

    -   Due ***Friday, October 31st, 11:59pm***
...
In groups we made $T = 2$ trees 'by hand'. To make each tree:
...
***This is a random forest consisting of*** $T = 2$ ***trees.***
